      ...
      <div className="flex min-h-screen flex-col justify-between">
          ...
          <nav className="flex h-12 items-center px-4 justify-between shadow-md">
            ...
            <div>
              <Link className="p-2" href="/cart">
                Cart
                {cartItemsCount > 0 && (
                  <span className="ml-1 rounded-full bg-red-600 px-2 py-1 text-xz font-bold text-white">
                    {cartItemsCount}
                  </span>
                )}
              </Link>
        ...
        <footer>
          <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
            <div>
              <h2 class="mb-6 text-sm font-semibold ">Company</h2>
              <ul class="">
                <li class="mb-4">
            ...
            <div>
              <h2 class="mb-6 text-sm font-semibold ">Help center</h2>
              <ul class="">
                <li class="mb-4">
                  <a href="#" class="hover:underline">
                    Discord Server
            ...
            <div>
              <h2 class="mb-6 text-sm font-semibold ">Download</h2>
              <ul class="">
                <li class="mb-4">
                  <a href="#" class="hover:underline">
                    iOS
